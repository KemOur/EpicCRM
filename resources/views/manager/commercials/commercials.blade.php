        ...
        <div style="background-color: #ffffff;margin: 10px" class="">
            ...
            <div style="margin: 10px">
                <div  style="margin: 10px" class="row align-items-md-stretch">
                    <div>
                        <a href="{{ route('manager.commercials.addcommercial') }}">
                            <div>
                        ...
                        @if($userlist->isNotEmpty())
                            @foreach ($userlist as $user)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('manager.commercials.editcommercial', $user->id )}}">
                                    ...
                                    <td>
                                        <form action="{{route('manager.commercials.destroy', $user->id)}}" method="post">
                                            @csrf
                                            @method('delete')
