        ...
        <div class="row">
            <div class="col-6 col-md">
                ...
                <ul class="list-unstyled text-small">
                    <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Le guide complet</a></li>
                    <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Organiser le suivie client</a></li>
                    <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Une bonne alternative à excel</a></li>
                </ul>
            </div>
            ...
            <div class="col-6 col-md">
                <h6>Mon compte</h6>
                <ul class="list-unstyled text-small">
                    <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Se connecter</a></li>
                    <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">S'inscrire</a></li>
                </ul>
            </div>
        </div>
    </div>
